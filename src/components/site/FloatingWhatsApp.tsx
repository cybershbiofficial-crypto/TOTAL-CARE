export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-[99] flex h-[60px] w-[60px] items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] transition-all duration-300 hover:scale-110 hover:shadow-[0_6px_20px_rgba(37,211,102,0.23)] md:bottom-8 md:right-8"
